# PowerShell script to test the enhanced securities extraction with sequential thinking
...
$testScript = Join-Path -Path $scriptPath -ChildPath "test_enhanced_extraction.py"
...
Write-Host "  with Sequential Thinking and Advanced AI" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "This test demonstrates the enhanced securities extraction capabilities" -ForegroundColor Yellow
Write-Host "using sequential thinking and advanced AI." -ForegroundColor Yellow
Write-Host ""
