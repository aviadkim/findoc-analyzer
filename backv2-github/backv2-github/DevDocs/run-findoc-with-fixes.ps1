# Run FinDoc with Fixes
# This script starts both the backend and frontend servers with the fixed pages
...
# Display information
Write-Host ""
Write-Host "FinDoc with Fixes is now running!"
Write-Host "Backend server: http://localhost:5000"
Write-Host "Frontend server: http://localhost:3002"
Write-Host ""
Write-Host "Fixed pages:"
Write-Host "- Documents page: http://localhost:3002/documents"
Write-Host "- Portfolio page: http://localhost:3002/portfolio"
