"""
Test script for improved financial document processing.

This script demonstrates the enhanced capabilities for processing financial documents,
with a focus on improved table extraction and securities information extraction.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Test improved financial document processing')
