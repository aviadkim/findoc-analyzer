    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                <li><a href="/documents"><span class="icon">📄</span> My Documents</a></li>
                <li><a href="/analysis"><span class="icon">📈</span> Analysis</a></li>
                <li><a href="/portfolio"><span class="icon">💼</span> Portfolio</a></li>
                <li><a href="/agents"><span class="icon">🤖</span> Agents</a></li>
                <li><a href="/document-understanding-demo"><span class="icon">🔍</span> Document Understanding</a></li>
                <li><a href="/test-sql-agent"><span class="icon">🗃️</span> SQL Agent</a></li>
                <li><a href="/test-web-browser"><span class="icon">🌐</span> Web Browser</a></li>
                <li><a href="/mcp-integration"><span class="icon">☁️</span> Google Cloud MCP</a></li>
                <li><a href="/dev-test-center"><span class="icon">⚙️</span> Testing</a></li>
                <li><a href="/api-key-setup"><span class="icon">🔑</span> API Setup</a></li>
                <li><a href="/settings"><span class="icon">⚙️</span> Settings</a></li>
                <li><a href="/api-keys"><span class="icon">🔑</span> API Keys</a></li>
            </ul>
        </nav>
