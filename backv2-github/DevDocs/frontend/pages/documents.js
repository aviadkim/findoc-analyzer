...
const mockDocuments = [
  ...
  {
    id: '5',
    name: 'Investment Strategy 2024',
    type: 'PDF',
    size: '2.1 MB',
    uploadDate: '2023-12-28',
    status: 'Processed',
    tags: ['Strategy', 'Investment', '2024'],
  },
];
    ...
    <FinDocUI>
      <Container maxW="container.xl" py={8}>
        ...
        <Flex mb={6} gap={4} direction={{ base: 'column', md: 'row' }}>
          ...
          <Button leftIcon={<FiFilter />} colorScheme="blue" variant="outline">
            More Filters
          </Button>
        </Flex>
                  ...
                  <Card key={doc.id} boxShadow="md" borderRadius="lg">
                    ...
                    <CardBody py={2}>
                      <Stack spacing={2}>
                        <Flex align="center">
                          <Box as={FiFile} mr={2} />
                          <Text fontSize="sm">{doc.type} • {doc.size}</Text>
                        </Flex>
                        <Flex align="center">
                          <Box as={FiCalendar} mr={2} />
                          <Text fontSize="sm">{doc.uploadDate}</Text>
                        </Flex>
                        <Flex align="center">
                          <Box as={FiTag} mr={2} />
                          <Flex wrap="wrap" gap={1}>
