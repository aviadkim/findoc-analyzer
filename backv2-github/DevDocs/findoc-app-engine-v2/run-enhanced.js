/**
 * FinDoc Analyzer Enhanced Edition Startup Script
 *
 * This script runs the enhanced version of the FinDoc Analyzer application.
 */

const path = require('path');
const fs = require('fs');
const app = require('./src/app-enhanced');
...
// Start server
app.listen(PORT, () => {
  console.log(`Enhanced FinDoc Analyzer Server running on port ${PORT}`);
  console.log(`Access the application at http://localhost:${PORT}`);
  console.log('Enhanced features available at http://localhost:${PORT}/api/enhanced/*');
});
