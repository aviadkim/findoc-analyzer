 ...
 * It runs tests in sequence, with detailed reporting and screenshots.
 */
...
function generateReport() {
  ...
  const reportPath = path.join(config.reportsDir, `report-${testResults.startTime}.json`);
  const htmlReportPath = path.join(config.reportsDir, `report-${testResults.startTime}.html`);
...
<body>
  <div class="container">
    ...
    <p><strong>Duration:</strong> ${testResults.duration / 1000} seconds</p>
