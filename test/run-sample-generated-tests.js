...
const config = {
  ...
  sampleSize: 3 // Number of tests to run from each category
};
...
async function runSampleTests() {
  console.log('Running sample generated tests...');
  ...
  console.log('\nAll sample generated tests completed');
}
