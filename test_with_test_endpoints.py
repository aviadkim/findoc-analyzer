"""
Test with Test Endpoints

This script tests the PDF processing functionality using the test endpoints.
"""
...
def upload_and_process_pdf(pdf_path):
    """
    Upload and process a PDF file using test endpoints.
    ...
    try:
        # Step 1: Upload the document using test endpoint
        ...
        try:
            ...
            # Step 2: Process the document using test endpoint
            ...
            try:
                ...
                # Step 3: Poll for processing status using test endpoint
                status = 'processing'
                document_data = None
                poll_count = 0
                ...
                while status == 'processing' and poll_count < max_polls:
                    ...
                    # Check status using test endpoint
                    status_response = requests.get(
                        f"{API_URL}/test/document/{document_id}"
                    )
                ...
                # Step 4: Ask questions about the document using test endpoint
                questions = [
                ...
                for question in questions:
                    ...
                    answer_response = requests.post(
                        f"{API_URL}/test/document/{document_id}/ask",
                        json={
                            'question': question
                        },
                        headers={
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage: python test_with_test_endpoints.py <pdf_path>")
        return
