  ...
  },
  {
    ...
    assertions: async (page) => {
      try {
        ...
        console.log('Could not find h1 element, checking for document-related content');
  ...
  },
  {
    ...
    assertions: async (page) => {
      try {
        ...
        console.log('Could not find h1 element, checking for analytics-related content');
        const content = await page.content();
        return content.includes('analytics') || content.includes('Analytics') || 
               content.includes('chart') || content.includes('visualization');
      }
    }
  },
  {
    ...
    assertions: async (page) => {
      try {
        ...
        console.log('Could not find h1 element, checking for upload-related content');
        const content = await page.content();
        return content.includes('upload') || content.includes('Upload') || 
  ...
  },
  {
    ...
    assertions: async (page) => {
      try {
        ...
        console.log('Could not find h1 element, checking for chat-related content');
        const content = await page.content();
        return content.includes('chat') || content.includes('Chat') || 
