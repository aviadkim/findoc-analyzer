/**
 * Bloomberg Agent API Test for Deployed Application
 *
...
const RESULTS_DIR = path.join(__dirname, 'test-deployed-bloomberg-agent-results');
...
<head>
  ...
  <title>Bloomberg Agent API Deployed Test Report</title>
  <style>
    body {
...
<body>
  <h1>Bloomberg Agent API Deployed Test Report</h1>
