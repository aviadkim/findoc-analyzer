"""
Test PDF Processing with Credentials

This script tests the PDF processing functionality with the test user credentials.
"""
...
def login():
    ...
    """
    logger.info(f"Logging in with email: {TEST_USER['email']}")
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Usage: python test_with_credentials.py <pdf_path>")
        return
