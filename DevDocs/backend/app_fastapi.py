...
@app.post("/api/documents/{document_id}/analyze", response_model=Dict[str, Any])
...
@app.post("/api/documents/process-and-analyze", response_model=Dict[str, Any])
...
@app.get("/api/documents/{document_id}/analysis", response_model=Dict[str, Any])
...
@app.post("/api/documents/compare", response_model=Dict[str, Any])
...
@app.post("/api/documents/{document_id}/report", response_model=Dict[str, Any])
...
@app.post("/api/documents/extract-data", response_model=Dict[str, Any])
