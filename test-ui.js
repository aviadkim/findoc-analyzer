 ...
 * Test UI
 *
 * This script tests the UI of the FinDoc Analyzer application using Puppeteer.
 */
...
async function runTests() {
  ...
  try {
    ...
    if (sidebarExists) {
      ...
      await takeScreenshot(page, '02-sidebar');
      ...
      if (documentsLink) {
        ...
        await takeScreenshot(page, '03-documents-page');
      ...
      if (analyticsLink) {
        // Use setTimeout instead of waitForTimeout
        await new Promise(resolve => setTimeout(resolve, 2000));
        await takeScreenshot(page, '04-analytics-page');
    ...
    if (uploadButtonExists) {
      ...
      await takeScreenshot(page, '05-upload-button');
      ...
      if (fileInputExists) {
        // Take a screenshot of the file input
        await page.evaluate(() => {
        ...
        await takeScreenshot(page, '07-file-input');
      }
    }
